...
function px(node, styleProperty) {
    var _a;
    const nodeWindow = (_a = node === null || node === void 0 ? void 0 : node.ownerDocument) === null || _a === void 0 ? void 0 : _a.defaultView;
    if (!nodeWindow) {
        return 0;
    }
    const val = parseFloat(nodeWindow
