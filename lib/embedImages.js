...
function embedImageNode(clonedNode, options) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        var nodeWindow, src;
        return __generator(this, function (_b) {
            nodeWindow = (_a = clonedNode === null || clonedNode === void 0 ? void 0 : clonedNode.ownerDocument) === null || _a === void 0 ? void 0 : _a.defaultView;
            if (!nodeWindow ||
                (!(clonedNode instanceof nodeWindow.HTMLImageElement &&
                    !(0, util_1.isDataUrl)(clonedNode.src)) &&
                    !(clonedNode instanceof nodeWindow.SVGImageElement &&
                        !(0, util_1.isDataUrl)(clonedNode.href.baseVal)))) {
                return [2 /*return*/, Promise.resolve(clonedNode)];
            }
            src = clonedNode instanceof nodeWindow.HTMLImageElement
                ? clonedNode.src
                : clonedNode.href.baseVal;
            return [2 /*return*/, Promise.resolve(src)
                    .then(function (url) {
                    return (0, getBlobFromURL_1.getBlobFromURL)(url, options);
                })
                    .then(function (data) {
