...
exports.getFontEmbedCSS = exports.toBlob = exports.toJpeg = exports.toPng = exports.toPixelData = exports.toCanvas = exports.toSvgImg = exports.toSvg = void 0;
...
function getImageSize(node, options) {
    ...
    var width = options.width || (0, util_1.getMarginedNodeWidth)(node);
    var height = options.height || (0, util_1.getMarginedNodeHeight)(node);
...
exports.toSvg = toSvg;
function toSvgImg(node, options) {
    if (options === void 0) { options = {}; }
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [2 /*return*/, toSvg(node, options).then(util_1.createImage)];
        });
    });
}
exports.toSvgImg = toSvgImg;
...
function toCanvas(node, options) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [2 /*return*/, toSvgImg(node, options).then(function (img) {
